...
public class FrameDatosConex extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FrameDatosConex
     */
    public FrameDatosConex() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("New Conection");
    ...
    public boolean esperandoIP = true;
    
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        EntryPoint.serverIP = jTextFieldIP.getText();
        EntryPoint.user = jTextFieldUser.getText();
        EntryPoint.pass = jTextFieldPass.getText();
        esperandoIP = false;
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameDatosConex.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameDatosConex().setVisible(true);
            }
        });
    }
