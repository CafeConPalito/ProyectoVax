...
package com.cafeconpalito.serverimagegame;
 ...
 * @author damt207
 */
public class ServerImageGame {

    public static String dirName= "imggame";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Logger.getLogger(ServerImageGame.class.getName()).log(Level.SEVERE, null, ex);
        }
